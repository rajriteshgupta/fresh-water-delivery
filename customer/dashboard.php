                    ...
                    <div id="myDIV">    
                     ...
                     <li  class="btn"><a href="../logout.php">Log out </a></li>
                      ...
                      <li  class="btn"><a href="../customer/order.php">Order</a></li>
     	               <li  class="btn"><a  href="" >Delivery details</a></li>
					           <li  class="btn"><a  href="#bookmark" >How it Work</a></li>
                      <li  class="btn"><button type="button" class="btn btn-warning text-white" data-toggle="modal" data-target="#userModal" onclick="hidebg()">profile</button></li>
                     </div>
